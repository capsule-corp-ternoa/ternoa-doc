...
:::info
 ## Please read steps before begin 

#### 1. change your file `.md` in `.mdx` file.
...
### 3. Common template to copy/past directly from `start-your-docs.mdx` : 
